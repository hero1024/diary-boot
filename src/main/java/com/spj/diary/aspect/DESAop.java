...
import com.spj.diary.common.util.Constant;
import com.spj.diary.common.util.DESUtil;
...
public class DESAop {
	 ...
	 * @param joinPoint
	 */
	@Before(value = "execution(* com.spj.diary.service.DiaryService.saveDiary(..)) " +
			"|| execution(* com.spj.diary.service.DiaryService.updateDiary(..))")
	...
	@Around(value = "execution(* com.spj.diary.service.DiaryService.listDiary(..)) "
			+ "|| execution(* com.spj.diary.service.DiaryService.getDiaryById(..))"
			+ "|| execution(* com.spj.diary.service.DiaryService.getDiary(..))"
			+ "|| execution(* com.spj.diary.service.DiaryService.getDiaryByScore(..))")
	 ...
	 * @throws Throwable
	 */
	@Around(value = "execution(* com.spj.diary.service.DiaryContentService.getDiaryContentById(..))")
